@extends('layouts.app')
@section('title', __('lang.production'))
@section('breadcrumbbar')
    <div class="breadcrumbbar">
        {{-- ///////// left side //////////// --}}
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title">@lang('lang.production')</h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">@lang('lang.dashboard')</a></li>
                    <li class="breadcrumb-item active" aria-current="page">@lang('lang.production')</li>
                </ol>
            </div>
        </div>
    </div> <br/><br/>
                                                ...
                                                <tbody class="tbody">
                                                    @foreach ($fill_press_requests as $index => $fill_press_request)
                                                        <tr>
                                                            ...
                                                            {{-- +++++++++++++++++ رقم التشغيل  +++++++++++++++++ --}}
                                                            <td class="col4" title="رقم التشغيل"></td>
                                                            {{-- +++++++++++++++++ الكود +++++++++++++++++ --}}
                                                            ...
                                                            <td class="col12" title="تكلفة الوحدة الواحدة"></td>
                                                            {{-- +++++++++++++++++ المحتوي الاصلي +++++++++++++++++ --}}
                                                            <td class="col13" title="المحتوي الاصلي"></td>
                                                            {{-- +++++++++++++++++ المحتوي الحالي +++++++++++++++++ --}}
                                                            <td class="col14" title="المحتوي الحالي"></td>
                                                            {{-- +++++++++++++++++ العيار +++++++++++++++++ --}}
                                                            ...
                                                            {{-- +++++++++++++++++ التكلفة الاجمالية +++++++++++++++++ --}}
                                                            <td class="col18" title="التكلفة الاجمالية"></td>
