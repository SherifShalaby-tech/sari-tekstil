<div class="row row_weight">
    ...
    <div class="col-md-2 pt-3">
        ...
        <input type="number" name="weight[]" class="form-control  weight nationality-weight" placeholder="0.00" 
            data-nationality=""  id = 'weight-input'>
    </div>
