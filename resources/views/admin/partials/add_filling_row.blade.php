...
<div class="row row_weight" style="margin: 0%">
    <table id="main">
        ...
        <th class="head"><input name="empty_weight[]" value="{{isset($filling_request->empty_weight)?$filling_request->empty_weight:null}}" class="form-control" type="number" placeholder="Emty Weight"></th>
