...
@section('page_title')
    @lang('lang.add_introduction_sheet')
@endsection

@section('breadcrumbs')
    @parent
    <li class="last active"><a href="#">@lang('lang.add_introduction_sheet')</a></li>
@endsection

@section('button')
    <a class="button"href="{{ route('introduction-sheet.index') }}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        {!! Form::open([
                            'route' => 'introduction-sheet.store',
                            'method' => 'post',
                            'files' => true,
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" class="form-control text" name="car_sku[]"
                                                    placeholder="@lang('lang.car_sku')" required>
                                                @error('car_sku')
