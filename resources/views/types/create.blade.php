<!-- Modal -->
<div class="modal fade" id="createTypeModal" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog  rollIn  animated" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => 'types.store', 'method' => 'post', 'files' => true,'id' =>'type-form' ]) !!}
...
{!! JsValidator::formRequest('App\Http\Requests\TypeRequest','#type-form'); !!}
