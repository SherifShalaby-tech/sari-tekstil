...
@section('breadcrumbs')
    ...
    <li class="last active"><a href="#">@lang('lang.edit_employees')</a></li>
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="password" class="form-control" value="{{ $employee->password }}" name="password"
                                id="inputPassword" placeholder="{{ __('lang.password') }}">
                            @error('password')
                                <label class="text-danger error-msg">{{ $message }}</label>
                            @enderror
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="password" class="form-control"value="{{ $employee->password }}"
                                name="password_confirmation" id="inputPassword"
                                ...
                                <tbody>
                                    @foreach ($week_days as $key => $week_day)
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::time('check_in[' . $key . ']', !empty($employee->check_in[$key]) ? $employee->check_in[$key] : null, [
