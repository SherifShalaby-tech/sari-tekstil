<!-- Modal -->
<div class="modal fade" id="createColorModal" tabindex="-1" role="dialog" aria-labelledby="exampleStandardModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog  rollIn  animated modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['route' => 'leaves.store', 'method' => 'post', 'files' => true,'id' =>'leaves-form' ]) !!}
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 if_paid hide">
                        ...
                        {!! Form::date('payment_date', null, ['class' => 'form-control datepicker', 'placeholder' =>
