...
@section('breadcrumbs')
    @parent
    <li class="last active"><a href="#">@lang('lang.employees')</a></li>
@endsection
@if (auth()->user()->can('employees_module.employee.create'))

    @section('button')
        <a class="button" href="{{ route('employees.create') }}">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach ($employees as $index => $employee)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td><img src="{{ asset('uploads/employees/' . $employee->photo) }}" alt="photo"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button employee="button" class="btn btn-default btn-sm dropdown-toggle"
