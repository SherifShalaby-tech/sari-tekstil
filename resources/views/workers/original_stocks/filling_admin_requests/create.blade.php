        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card m-b-30 p-2">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <h5 class="pt-5">{{ __('lang.shipment_number')}} : {{isset($opening_requests->shipment_number)?$opening_requests->shipment_number:''}}</h5>
                        </div>
                      
                        <div class="col-md-3">
                            <h5 class="pt-5">{{ __('lang.batch_number')}} :  {{isset($opening_requests->batch_number)?$opening_requests->batch_number:''}}</h5>
                        </div>
                      <div class="col-md-6"></div>
                        
                            <div class="col-md-3">
                            <h5 class="pt-5">{{ __('lang.date')}} :  {{isset($opening_requests->created_at)?$opening_requests->created_at:''}}</h5>
                            </div>
                        <div class="col-md-3">
                            <h5 class="pt-5">{{ __('lang.requested_weight')}} :  {{isset($opening_requests->requested_weight)?@num_format($opening_requests->requested_weight):0}}</h5>
                        </div>
                        <div class="col-md-3" >
                            <h5 class="pt-5">{{ __('lang.type')}} :  {{isset($opening_requests->type_id)?$opening_requests->type->name:0}}</h5>
                        </div>
                        
                        <div class="col-md-3">
                            <h5 class="pt-5">{{ __('lang.priority')}} :  {{isset($opening_requests->priority)?$opening_requests->priority:''}}</h5>
                        </div>
                    </div>
