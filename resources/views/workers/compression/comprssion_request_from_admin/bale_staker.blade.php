    ...
    <div class="col-md-12 content_div" id="content_div">
            ...
            <div class="col-md-12">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width:9%">@lang('lang.content')</th>
                        <th style="width:10%">@lang('lang.filling')</th>
                    </tr>
                </thead>
                <tbody>
                    <td>{{$bale->weight}} Kg</td>
                    <td>{{$bale->car->name}}</td>
                    <td>{{$bale->press_request->screening->name??""}}</td>
                    <td>{{$bale->press_request->fills->name??''}}</td>
                </tbody>
            </table>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div>
                    {!! DNS1D::getBarcodeSVG($bale->sku, "C128", 2, 80, '#2A3239') !!}
                </div>
            </div>
        </div>
        <br>
