<div>
    ...
    <div class="row">
        <div class=" col-md-3 form-group">
            <label class="h6 pt-3">{{__( 'lang.supplier' )}}</label>
        ...
        <div  class="col-md-4 form-group">
            <label class="h6 pt-3">{{__( 'lang.type' )}}</label>
        ...
        <div class="col-md-3 form-group">
            ...
            <input type="number" id="internalTransportCost" wire:model="internalTransportCost" class="form-control ">
        </div>
        <div class="col-md-3 form-group">
