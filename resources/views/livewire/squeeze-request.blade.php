                                ...
                                <tbody>
                                    @foreach ($cars as $index => $car)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $employeesString = implode(
                                                        ', ',
                                                        \App\Models\Employee::whereIn(
                                                            'id',
                                                            $car->car_extras->pluck('employee_id')->toArray(),
                                                        )
                                                            ->pluck('name')
                                                            ->toArray(),
                                                    );
                                            ...
                                            <td>
                                                ...
                                                @php
                                                    $calibarsString = implode(
                                                        ', ',
                                                        $car->car_extras->pluck('caliber_id')->toArray(),
                                                    );
                                                @endphp
                                                {{ $calibarsString }}<br>
                                            </td>
                                            ...
                                            <td><input type="text"
                                                    wire:model="rows.{{ $index }}.num_of_bales"
